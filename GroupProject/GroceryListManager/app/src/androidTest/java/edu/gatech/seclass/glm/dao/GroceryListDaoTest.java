...
public class GroceryListDaoTest {
    private GroceryListDao database;

    @Before
    public void setUp() throws Exception {
        getTargetContext().deleteDatabase(DBContract.DATABASE_NAME);
        database = new GroceryListDao(getTargetContext());
    }
    ...
    @Test
    public void shouldAddGroceryList() throws Exception {
        ...
        assertTrue(groceryLists.get(0).getName().equals("Food"));
    }
